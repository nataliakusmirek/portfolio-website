...
function App() {
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="#" style={{marginTop:20, color:"white"}}>Projects</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#" style={{marginTop:20, color:"white"}}>Tutoring</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><img src="logo.png" id="logo" style={{width:80,height:80}}alt=" "></img></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#" style={{marginTop:20, color:"white"}}>Contact</a>
      </li>
      <li class="nav-item" style={{marginTop:20, color:"white"}}>
        ...
        <div class="about" style={{marginTop:80}}>
            ...
            <h3 class="aboutINFO" style={{color:"#6D67E4",marginLeft:810, marginTop:20,fontSize:21, width:390, textAlign:"right"}}>Greetings! My name is Natalia and I am currently studying for a Bachelors in Computer Science and Bachelors in Business Administration. 
        ...
        <div class="project" style={{marginTop:700, width:1000}}>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item" data-bs-interval="1700" style={{color:"#46C2CB"}}>
      <img src="project.png" class="d-block w-100" alt="..."></img>
      <div class="carousel-caption d-none d-md-block"   style={{top:170}}>
...
<h3 style={{color:"white",opacity:50,marginLeft: 575, marginTop:-470, fontSize:25, position:"absolute",opacity:0.6}}>here's some things i've worked on.</h3>
        ...
        <div class="tutor" style={{marginTop:500}}>
            ...
            <h3 style={{color:"#9681FA",width:700,marginLeft:275, marginTop:20,fontSize:17,textAlign:"left", position:"absolute"}}>Using projects based on level (beginner, intermediate, advanced) that cover certain programming concept(s), students learn in groups of 1-3 twice a week on Zoom completing these projects together. This allows students to learn how to debug and improve code collaboratively. Parents are updated biweekly via email on their child's performance.
            </h3>
